/*
Procedure to load the data from external CSV files
*/
...
DECLARE @start_time DATETIME , @end_time DATETIME ,@batch_start_time DATETIME , @batch_end_time DATETIME
	BEGIN TRY
		...
		PRINT'>> Load Duration: '+ CAST(DATEDIFF(second,@start_time, @end_time) AS NVARCHAR) +'seconds';
			...
			--SELECT COUNT(*) AS PROD_INFO_COUNT FROM bronze.crm_prd_info;
		SET @start_time = GETDATE();
		...
		--SELECT COUNT(*) AS SALES_DETAILS_COUNT FROM bronze.crm_sales_details;
			PRINT '-------------------------------------'
		...
		--SELECT COUNT(*) AS CUST_AZ12_COUNT FROM bronze.erp_cust_az12;
		SET @start_time = GETDATE();
		PRINT '>>Truncating Table: bronze.erp_loc_a101'
		TRUNCATE TABLE bronze.erp_loc_a101
		PRINT '>>Inserting Data Intp: bronze.erp_loc_a101'
		...
		--SELECT COUNT(*) AS LOC_A101_COUNT FROM bronze.erp_loc_a101;
		SET @start_time = GETDATE();
	...
	BEGIN CATCH
		PRINT '====================================='
		PRINT 'Error Occurred during the bronze load'
